 ...
 *
 * Limits, capabilities and costs are sourced from models.dev (Command Code bills
 * at underlying upstream rates with no markup). Unknown future models fall back to
 * family rules below. Users can override any of this per model in opencode.json under
...
export const KNOWN_MODELS: Record<string, ModelMeta> = {
  "claude-sonnet-5": { output: 128000, reasoning: true, attachment: true, release_date: "2026-06-29", cost: { input: 2, output: 10, cache_read: 0.2, cache_write: 2.5 } },
  "claude-sonnet-4-6": { output: 128000, reasoning: true, temperature: true, attachment: true, release_date: "2026-02-17", cost: { input: 3, output: 15, cache_read: 0.3, cache_write: 3.75 } },
  "claude-fable-5-1": { output: 128000, reasoning: true, attachment: true, release_date: "2026-09-01", cost: { input: 10, output: 50, cache_read: 0.25, cache_write: 12.5 } },
  "claude-fable-5": { output: 128000, reasoning: true, attachment: true, release_date: "2026-06-07", cost: { input: 10, output: 50, cache_read: 1, cache_write: 12.5 } },
  "claude-opus-5": { output: 128000, reasoning: true, attachment: true, release_date: "2026-07-24", cost: { input: 5, output: 25, cache_read: 0.5, cache_write: 6.25 } },
  "claude-opus-4-8": { output: 128000, reasoning: true, attachment: true, release_date: "2026-05-28", cost: { input: 5, output: 25, cache_read: 0.5, cache_write: 6.25 } },
  "claude-opus-4-7": { output: 128000, reasoning: true, attachment: true, release_date: "2026-04-14", cost: { input: 5, output: 25, cache_read: 0.5, cache_write: 6.25 } },
  "claude-haiku-4-5-20251001": { output: 64000, reasoning: true, temperature: true, attachment: true, release_date: "2025-10-15", cost: { input: 1, output: 5, cache_read: 0.1, cache_write: 1.25 } },
  "gpt-5.6-sol": { output: 128000, reasoning: true, attachment: true, release_date: "2026-07-09", cost: { input: 4, output: 20, cache_read: 0.4, cache_write: 5 } },
  "gpt-5.6-terra": { output: 128000, reasoning: true, attachment: true, release_date: "2026-07-09", cost: { input: 2, output: 12, cache_read: 0.2, cache_write: 2.5 } },
  ...
  "gpt-5.5": { output: 128000, reasoning: true, attachment: true, release_date: "2026-04-23", cost: { input: 5, output: 30, cache_read: 0.5 } },
  "gpt-5.4": { output: 128000, reasoning: true, temperature: true, attachment: true, release_date: "2026-03-05", cost: { input: 2.5, output: 15, cache_read: 0.25 } },
  "gpt-5.3-codex": { output: 128000, reasoning: true, temperature: true, attachment: true, release_date: "2026-02-05", cost: { input: 1.75, output: 14, cache_read: 0.175 } },
  ...
  "moonshotai/Kimi-K3": { output: 131072, reasoning: true, attachment: true, interleaved: "reasoning_content", release_date: "2026-07-16", cost: { input: 3, output: 15, cache_read: 0.3 } },
  ...
  "moonshotai/Kimi-K2.6": { output: 262144, reasoning: true, temperature: true, attachment: true, interleaved: "reasoning_content", release_date: "2026-04-21", cost: { input: 0.95, output: 4, cache_read: 0.16 } },
  "moonshotai/Kimi-K2.5": { output: 262144, reasoning: true, temperature: true, attachment: true, interleaved: "reasoning_content", release_date: "2026-04-21", cost: { input: 0.95, output: 4, cache_read: 0.16 } },
  ...
  "zai-org/GLM-5.3": { output: 131072, reasoning: true, temperature: true, interleaved: "reasoning_content", release_date: "2026-08-14", cost: { input: 1.4, output: 4.4, cache_read: 0.26, cache_write: 0 } },
  ...
  "zai-org/GLM-5": { output: 131072, reasoning: true, temperature: true, interleaved: "reasoning_content", release_date: "2026-02-11", cost: { input: 1, output: 3.2, cache_read: 0.2, cache_write: 0 } },
  ...
  "MiniMaxAI/MiniMax-M2.5": { output: 131072, reasoning: true, temperature: true, release_date: "2026-02-12", cost: { input: 0.3, output: 1.2, cache_read: 0.03, cache_write: 0.375 } },
