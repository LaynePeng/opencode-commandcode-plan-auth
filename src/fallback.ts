/**
 * Snapshot of the Command Code model catalog at build time.
 * Used when the live /provider/v1/models endpoint is unreachable and no cache exists.
 */

export type RawModel = { id: string; name?: string; context_length?: number }

export const FALLBACK_MODELS: RawModel[] = [
